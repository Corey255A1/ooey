...
int main() {
    ...
    dark_theme->set_style("title-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 180, 240}});
    ...
    dark_theme->set_style("primary-btn", Style{.fill_color=Color{0, 120, 215}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 255, 255}, .corner_radius=8});
    dark_theme->set_style("secondary-btn", Style{.fill_color=Color{50, 50, 55}, .stroke_color=Color{80, 80, 90}, .stroke_thickness=1.5f, .text_color=Color{220, 220, 230}, .corner_radius=8});
    dark_theme->set_style("card-bg", Style{.fill_color=Color{35, 35, 40}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 0, 0, 0}, .corner_radius=6});
    dark_theme->set_style("card-title-accent", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 180, 240}});
    dark_theme->set_style("card-title-accent-green", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 200, 100}});
    dark_theme->set_style("card-title-accent-orange", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{235, 160, 0}});
    dark_theme->set_style("card-title-accent-purple", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{180, 100, 240}});
    dark_theme->set_style("card-muted-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{180, 180, 190}});
    dark_theme->set_style("text-input", Style{.fill_color=Color{35, 35, 40}, .stroke_color=Color{80, 80, 90}, .stroke_thickness=1.5f, .text_color=Color{255, 255, 255}, .corner_radius=6});
    dark_theme->set_style("default-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{200, 200, 200}});
    ...
    light_theme->set_style("title-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 90, 180}});
    light_theme->set_style("subtitle-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{100, 100, 110}});
    light_theme->set_style("primary-btn", Style{.fill_color=Color{0, 100, 200}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 255, 255}, .corner_radius=8});
    light_theme->set_style("secondary-btn", Style{.fill_color=Color{220, 220, 225}, .stroke_color=Color{180, 180, 190}, .stroke_thickness=1.5f, .text_color=Color{40, 40, 45}, .corner_radius=8});
    light_theme->set_style("card-bg", Style{.fill_color=Color{255, 255, 255}, .stroke_color=Color{210, 210, 215}, .stroke_thickness=1.0f, .text_color=Color{0, 0, 0, 0}, .corner_radius=6});
    light_theme->set_style("card-title-accent", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 100, 200}});
    light_theme->set_style("card-title-accent-green", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 150, 50}});
    light_theme->set_style("card-title-accent-orange", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{200, 100, 0}});
    light_theme->set_style("card-title-accent-purple", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{120, 40, 180}});
    light_theme->set_style("card-muted-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{80, 80, 90}});
    light_theme->set_style("text-input", Style{.fill_color=Color{255, 255, 255}, .stroke_color=Color{180, 180, 190}, .stroke_thickness=1.5f, .text_color=Color{0, 0, 0}, .corner_radius=6});
    light_theme->set_style("default-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{50, 50, 50}});
    ...
    cyberpunk_theme->set_style("title-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 0, 128}});
    cyberpunk_theme->set_style("subtitle-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 255, 255}});
    cyberpunk_theme->set_style("primary-btn", Style{.fill_color=Color{255, 255, 0}, .stroke_color=Color{255, 0, 128}, .stroke_thickness=2.0f, .text_color=Color{0, 0, 0}, .corner_radius=0});
    cyberpunk_theme->set_style("secondary-btn", Style{.fill_color=Color{0, 0, 0}, .stroke_color=Color{0, 255, 255}, .stroke_thickness=2.0f, .text_color=Color{0, 255, 255}, .corner_radius=0});
    cyberpunk_theme->set_style("card-bg", Style{.fill_color=Color{20, 20, 30}, .stroke_color=Color{255, 0, 128}, .stroke_thickness=1.5f, .text_color=Color{0, 0, 0, 0}, .corner_radius=0});
    cyberpunk_theme->set_style("card-title-accent", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 255, 0}});
    cyberpunk_theme->set_style("card-title-accent-green", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 255, 128}});
    cyberpunk_theme->set_style("card-title-accent-orange", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 128, 0}});
    cyberpunk_theme->set_style("card-title-accent-purple", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 0, 255}});
    cyberpunk_theme->set_style("card-muted-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{0, 255, 255}});
    cyberpunk_theme->set_style("text-input", Style{.fill_color=Color{15, 15, 25}, .stroke_color=Color{0, 255, 255}, .stroke_thickness=1.5f, .text_color=Color{0, 255, 255}, .corner_radius=0});
    cyberpunk_theme->set_style("default-text", Style{.fill_color=Color{0, 0, 0, 0}, .stroke_color=Color{0, 0, 0, 0}, .stroke_thickness=0.0f, .text_color=Color{255, 255, 0}});
